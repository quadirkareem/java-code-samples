...
public class TestExponentialBackoff2V3 {

	public static void main(String[] args) {
		boolean success = doExponentialBackoffVerification("Hyd", "Delhi", "Bangalore");
		System.out.println("Final Result: " + success);
	}

	// boolean doExponentialBackoffVerification(Function<String, Boolean>
	// method, String input) {
	static boolean doExponentialBackoffVerification(String s1, String s2, String s3) {
        int maxRetries = 3;
        int retryCount = 0;
        int delayMinutes = 2;
...
//            success = method.apply(input);
            ActionVerifier av = new ActionVerifier() { 
            	 @Override
